...
const Card = ({ r = "full", img, product }) => {
    ...
    return (
        <div className={`py-2 w-[45vw]  hover:scale-90 transition-all flex flex-col items-center ease-in-out rounded shrink-0`}>
            ...
            <button onClick={addCart} className='outline-1 flex justify-center items-center gap-4 w-full py-1 text-xl outline-gray-500 capitalize rounded-3xl'>
