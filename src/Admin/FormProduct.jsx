            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md relative">
                ...
                <form onSubmit={formhandler} >
                    <div className="flex flex-col items-center">
                        ...
                        <input value={form.discount || ''} onChange={(e) => setForm({ ...form, discount: e.target.value })} type="string" placeholder="Discount % (Optional)" className="mt-4 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition" />
